...
const AboutMe = () => {
  return (
    <div className="bg-black pt-14 pb-1 md:px-10 ">
      <h1
        data-aos="fade-right"
          ...
          >
            <div className="p-5 md:p-14 xl:p-16">
              ...
              <p className="text-xs lg:text-base text-white">
                ...
                dynamic digital experiences. I am committed to crafting
                solutions that seamlessly blend functionality with aesthetics.
                Beyond the code, I am passionate about staying at the forefront
                of industry trends and continuously expanding my knowledge. Let
                us embark on a journey of innovation and bring your digital
                vision to life.
              </p>
            </div>
          </div>
